...
- Overall status: Feature complete and deployed; the children have now played on their own iPads, and what that first play exposed is fixed and waiting to be deployed: two layout and input defects, plus the two changes the owner asked for afterwards, icons on every control and opening a chest by tapping it
